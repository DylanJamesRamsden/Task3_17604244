...
{
    [Serializable]
    class BarbarianMelee : Unit //Identical to that of the Melee Unit, thus is why there are no comments
    {
        public string Name
        {
        ...
        public BarbarianMelee(string uname, int xP, int yP, String unitFaction, string unitSymbol) 
        {
            Name = uname;
            XPos = xP;
            YPos = yP;
        ...
        //public override Building closestBuilding(Building[] MapOfBuildings)
        //{
        //    Building ClosestBuild = MapOfBuildings[0];
        //    int Distance = 50;

        //    for (int b = 0; b < 6; b++)
        //    {
        //        if (MapOfBuildings[b].GetType() == typeof(ResourceBuilding))
        //        {
        //            ResourceBuilding Current = (ResourceBuilding)MapOfBuildings[b];
        //            if (XPos != Current.XPos && YPos != Current.YPos && Current.Faction != Faction && Current.isDead() == false)
        //            {
        //                if (Distance > DistanceTo(Current))
        //                {
        //                    Distance = DistanceTo(Current);
        //                    ClosestBuild = MapOfBuildings[b];
        //                }
        //            }
        //        }
        //        else
        //        {
        //            FactoryBuilding Current = (FactoryBuilding)MapOfBuildings[b];
        //            if (XPos != Current.XPos && YPos != Current.YPos && Current.Faction != Faction && Current.isDead() == false)
        //            {
        //                if (Distance > DistanceTo(Current))
        //                {
        ...
        //        int d = Math.Abs(XPos - temp.XPos) + Math.Abs(YPos - temp.YPos);
        //        return d;
        //    }
        //    else
        //    {
